...
// function find2020 ( first_index, second_index, third_index) {
// 	console.log(first_index, second_index, third_index)
// 	console.log(input[first_index], input[second_index], input[third_index])
// 	if (input[first_index] + input[second_index] + input[third_index] == 2020) {
// 		console.log( "Found it " + input[first_index] + " " + input[second_index] + " " + input[third_index])
// 		console.log("Answer " + (input[first_index] * input[second_index] * input[third_index]))
// 	}
// 	else if (input[first_index] + input[second_index] + input[third_index] > 2020) {
// 		find2020(first_index, second_index + 1, third_index - 1 )
// 	}
// 	else {
// 		if (third_index + 1 < input.length) {
// 			find2020(first_index, second_index, third_index + 1 )
// 		} else if (second_index < third_index) {
// 			find2020(first_index, second_index + 1, third_index)
// 		} else {
// 			find2020(first_index + 1, second_index, third_index)
// 		}
// 	}
// }
